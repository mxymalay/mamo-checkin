...
const configured={...DEFAULTS,email:'student@example.edu',name:'Example Student',courses:['FIT5120'],senders:{FIT5120:'teacher@example.edu'},moodleUrls:{FIT5120:[]}};
...
test('settings reject non-Moodle action URLs and account changes when records exist',()=>{
 ...
 assert.throws(()=>normalizeSettings(configured,{email:'someone@monash.edu'},true),/切换账号/);
});
