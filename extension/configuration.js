...
const FIELDS=['enabled','email','name','intervalMinutes','academicYear','mailQuery','courses','senders','subjectKeywords','moodleUrls','edUrls','schedules','ignoreCompleted','devMode'];
